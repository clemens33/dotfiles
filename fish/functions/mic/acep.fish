function acep --description "argocd for da-k8s-emea-prod"
    # Set environment for this cluster
    set -lx KUBECONFIG /home/ckriech/.kube/da-k8s-emea-prod
    set -l context AKS-DEW-Analytics-Prod-001-pinniped
    ...
    echo "Connecting to Argo CD (emea-prod)..."
