function acap --description "argocd for da-k8s-amer-prod"
    # Set environment for this cluster
    set -lx KUBECONFIG /home/ckriech/.kube/da-k8s-amer-prod
    set -l context AKS-USEast-Analytics-Prod-001-pinniped
    ...
    echo "Connecting to Argo CD (amer-prod)..."
