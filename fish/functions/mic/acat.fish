function acat --description "argocd for da-k8s-amer-test"
    # Set environment for this cluster
    set -lx KUBECONFIG /home/ckriech/.kube/da-k8s-amer-test
    set -l context AKS-USEast-Analytics-001-pinniped
    ...
    echo "Connecting to Argo CD (amer-test)..."
