...
Bulky material lives in sibling files; load only when needed:

- **`reference/pmbok-examples.md`** — full XML examples for WBS, RACI Matrix, and Stakeholder Power-Interest Grid
- **`reference/styles-and-themes.md`** — color schemes (blue/green/corporate/risk) and connector style strings
